        ...
        <div class="col-md-12">
            ...
            <div class="card profile-card">
                <div class="card-header">
                    ...
                    <h3 class="update-profile">Update profile</h3>
                </div>
                ...
                <form method="POST" action="{{ route('customer.profileupdate') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="address" value="{{ $user->address }}" id="exampleInputEmail1" placeholder="Enter address">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputFile">Image</label>
                            <div class="custom-file">
                                <input type="file" class="input-file uniform_on" id="exampleInputFile" name="image">
